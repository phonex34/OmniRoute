...
// If input became empty (e.g. every item was a stored-item reference the
// backend can no longer resolve with store=false), substitute a minimal
// "continue" turn — an empty input array is rejected upstream.
